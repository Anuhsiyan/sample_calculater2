...
namespace sample_calculater_2
{
    ...
    public class MainForm : Form
    {
        ...
        private void CalculateButton_Click(object sender, EventArgs e)
        {
            ...
            if(num1 != int.MinValue && num2 != int.MaxValue)
            {
                ...
                {
                    resultLabel.Text = "Please select an operatin. ";
                }
            }
        ...
        private int GetNumberFromTextBox(TextBox textBox)
        {
            ...
            {
                resultLabel.Text = "Please enter valid integer .";
